...
캘린더·건강·운동기록을 종합해 이번 주 맞춤 운동 스케줄을 자동 생성·재조정하는 LangGraph Agent + Flutter Web 데모. ASM 17기 AI43조(5인) 1주짜리 팀 프로젝트.
...
실제 Google Calendar / Apple Health 연동은 MVP 범위 외 — Supabase 테이블이 단일 진실 소스다.

## 화면

데모 메인은 좌측 카드 3종(이번 주 일정 / 컨디션 / 최근 운동) + 가운데 부위별 피로도 레이더 + 우측 AI 코치 채팅 한 페이지.

레이아웃 레퍼런스: [`docs/design/ChatGPT Image 2026년 5월 4일 오전 01_17_14.png`](docs/design/ChatGPT%20Image%202026%EB%85%84%205%EC%9B%94%204%EC%9D%BC%20%EC%98%A4%EC%A0%84%2001_17_14.png) · 인터랙션 흐름: [`docs/design/flow.html`](docs/design/flow.html)
