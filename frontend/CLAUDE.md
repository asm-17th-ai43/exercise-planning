...
데모 메인 화면 — 좌측 카드 3종(이번 주 일정 / 컨디션 점수 / 최근 운동 이력) + 가운데 부위별 피로도 레이더 + 우측 AI 코치 채팅. `ChatGPT Image 2026년 5월 4일 오전 01_17_14.png` 참고.
...
- 디자인: `ChatGPT Image 2026년 5월 4일 오전 01_17_14.png` 톤 유지. 색맹 친화 팔레트.
